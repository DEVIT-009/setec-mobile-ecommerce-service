...
# PATCH  /api/v1/admin/reviews/<str:review_id>/
# DELETE /api/v1/admin/reviews/<str:review_id>/
urlpatterns = [
    path('reviews/', AdminReviewListView.as_view(), name='admin-review-list'),
    path('reviews/<str:review_id>/', AdminReviewDetailView.as_view(), name='admin-review-detail'),
]
