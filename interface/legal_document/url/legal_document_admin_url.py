...
# DELETE /api/v1/admin/legal-documents/<str:legal_document_id>/
urlpatterns = [
    path('legal-documents/', AdminLegalDocumentListView.as_view(), name='admin-legal-document-list'),
    path('legal-documents/<str:legal_document_id>/', AdminLegalDocumentDetailView.as_view(), name='admin-legal-document-detail'),
]
