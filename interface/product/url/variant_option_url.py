...
urlpatterns = [
    ...
    path('public/product/variant-options/<str:option_id>/', VariantOptionPublicView.as_view({'get': 'retrieve'}), name='public-variant-option-detail'),
    ...
    path('admin/product/variant-options/<str:option_id>/', VariantOptionAdminView.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}), name='admin-variant-option-detail'),
]
