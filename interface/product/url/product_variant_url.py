...
urlpatterns = [
    ...
    path('public/product/variants/<uuid:variant_id>/', ProductVariantPublicView.as_view({'get': 'retrieve'}), name='public-product-variant-detail'),
    ...
    path('admin/product/variants/<uuid:variant_id>/', ProductVariantAdminView.as_view({'get': 'retrieve', 'put': 'update', 'patch': 'partial_update', 'delete': 'destroy'}), name='admin-product-variant-detail'),
]
