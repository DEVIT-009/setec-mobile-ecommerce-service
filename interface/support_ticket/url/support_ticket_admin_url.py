...
# PATCH /api/v1/admin/support/tickets/<str:ticket_id>/
...
urlpatterns = [
    ...
    path('support/tickets/<str:ticket_id>/', AdminSupportTicketDetailView.as_view(), name='admin-support-ticket-detail'),
    path('support/tickets/<str:ticket_id>/messages/', AdminSupportTicketReplyView.as_view(), name='admin-support-ticket-reply'),
]
